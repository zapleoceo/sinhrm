...
describe('detectSite', () => {
  it.each([
    ...
    ['https://robota.ua/candidates/12345678', 'robota_ua'],
    ['https://www.robota.ua/ru/candidates/12345678/', 'robota_ua'],
    ['https://robota.ua/ua/cv/test-slug', 'robota_ua'],
