...
найма, OKR, eNPS, настроение, SLA обращений, активы — плюс **конструктор**: выбрать набор данных, колонки, фильтры,
...
## Как проверить
`php artisan test --filter=Reports` — состав каталога по ролям (20 отчётов у админа, нет pay gap), область People и
