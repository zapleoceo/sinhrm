...
- Меню: раздел «Сервіси» (Мої звернення, База знань, Safe Speak, Каталог звітів, Конструктор звітів) для всех;
  в «Адміністрування» — Черга звернень, Вхідні Safe Speak, Активи. Пункт «Звіти» рекрутинга (`/reports`) подсвечивается
