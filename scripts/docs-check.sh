...
# Required doc: docs/modules/<name>.md in kebab-case (GoogleWorkspace → google-workspace, SafeSpeak → safe-speak, HiringRequests and
#               features/hiring-requests → hiring-requests, Time and features/time → time, features/mail-agent → mail-agent).
