...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'SinHRM HTTP API. Auth: Sanctum SPA session cookie + X-XSRF-TOKEN (see docs/guides/api.md).',
    ],
    ...
    // Superadmin only (same gate as the integrations admin); not public on any env — docs/guides/api.md.
    'middleware' => [
        'web',
        'auth:sanctum',
        EnsureUserIsActive::class,
        'can:'.IntegrationsServiceProvider::MANAGE_INTEGRATIONS,
    ],
