...
{
    private const array FIELDS = ['title', 'branch_id', 'department_id', 'position_id', 'recruiter_id', 'pipeline_id', 'status', 'description'];
    ...
    public function vacancyData(): VacancyData
    {
        ...
        foreach (['branch_id', 'department_id', 'position_id', 'recruiter_id', 'pipeline_id'] as $id) {
