...
/**
 * "pulse.tick" for POST /api/ops/jobs/run (cron every ~30 min): closes ended waves, opens scheduled ones (wiping
...
final readonly class PulseTickJob implements ScheduledJob
{
    ...
    {
        // Close first: in a recurring series a wave always ends before the next one opens.
        $closed = 0;
        $scheduled = 0;
